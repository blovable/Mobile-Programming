...
class MainActivity : AppCompatActivity() {
    ...
    private fun tambahKartu() {
        ...
        titleTextView.text = "Apa itu Kartoo?"

        // Mengatur deskripsi kartu
        descriptionTextView.text = "Kartoo adalah kartu kecil yang berisi pesan singkat atau ucapan yang ditujukan untuk dikirimkan kepada seseorang"
